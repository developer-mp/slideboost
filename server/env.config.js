...
const REFRESH_TOKEN_EXPIRATION = parseInt(getEnvVar("REFRESH_TOKEN_EXPIRATION"), 10);
const VERIFICATION_CODE_EXPIRATION = parseInt(getEnvVar("VERIFICATION_CODE_EXPIRATION"), 10);
...
const STORAGE_AUTH_TOKEN_DURATION = parseInt(getEnvVar("STORAGE_AUTH_TOKEN_DURATION"), 10);
