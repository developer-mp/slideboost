...
const BALANCE_ENDPOINT = getEnvVar("BALANCE_ENDPOINT");
const SURVEY_ENDPOINT = getEnvVar("SURVEY_ENDPOINT");
...
const CHECKOUT_ENDPOINT = getEnvVar("CHECKOUT_ENDPOINT");
const VERIFY_PAYMENT_ENDPOINT = getEnvVar("VERIFY_PAYMENT_ENDPOINT");
