        ...
        <Col xs={12} md={10} lg={8}>
          ...
          <div className="tw-text-gray-700 tw-mx-auto tw-max-w-3xl tw-text-justify">
            ...
            <p className="tw-mb-4">
              ...
              and concerning your access to and use of the Services. You agree
            ...
            <p className="tw-mb-4">
              ...
              Terms, please address your request to: If we ever grant you the
            ...
            <p className="tw-mb-12">
              ...
              laws of and yourself irrevocably consent that the courts of shall
            ...
            <p className="tw-mb-4">
              ...
              least days before initiating arbitration. Such informal
            ...
            <p className="tw-mb-4">
              ...
              Arbitration Chamber (Belgium, Brussels, Avenue Louise, 148)
